...
module.exports = (
    <Router history={history}>
        <Route component={views.Root} name="root">
            ...
            <Route component={views.Users} name="users" path="/users/" titleView="Amministrazione utenti" onEnter={requireAdminAuthorization} />
            ...
            <Route component={views.Monitoring} name="monitoring" path="/monitoring/" titleView="Monitoring" onEnter={requireYousaveAuthorization} />
            <Route component={views.MonitoringChartView} name="monitoring-chart" path="/monitoring/chart/" titleView="Monitoring chart" onEnter={requireYousaveAuthorization} />
            <Route component={views.MonitoringFavoritesCharts} name="monitoring-favorites-charts" path="/monitoring/favorites/" titleView="Favorites charts" onEnter={requireYousaveAuthorization} />
        </Route>
    </Router>
);
