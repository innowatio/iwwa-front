    ...
    describe.skip("the `convertByVariables` function", function () {
        ...
        it("should return the correct array with single variable", function () {
            ...
            var expected = [
                ...
                [new Date(toDateTime(1)), [parseFloat(11)]],
                [new Date(toDateTime(2)), [parseFloat(2)]],
                [new Date(toDateTime(3)), [parseFloat(12)]],
                [new Date(toDateTime(4)), [parseFloat(null)]],
                [new Date(toDateTime(5)), [parseFloat(14)]],
                [new Date(toDateTime(6)), [parseFloat(1.1)]]
            ];
